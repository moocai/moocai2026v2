...
export const exercises: Exercise[] = [
  {
    ...
    challenge: { ca: "Imprimir per pantalla: Hello, World entre cometes dobles com el example", es: "Imprimir por pantalla: Hello, World entre comillas dobles como el example", en: "Print to screen: Hello, World between double quotes like example" },
    initialCode: "",
